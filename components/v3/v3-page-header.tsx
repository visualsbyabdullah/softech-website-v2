  ...
  return (
    <>
      <header className={styles.header}>
        ...
        <Link href="/v3/contact" className={styles.quoteButton}>
          Get a Quote
        </Link>
      </header>
